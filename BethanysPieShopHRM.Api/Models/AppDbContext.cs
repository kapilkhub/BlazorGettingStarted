...
namespace BethanysPieShopHRM.Api.Models
{
	public class AppDbContext : DbContext
	{
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Benefit>().HasData(new Benefit { Id = 1, Description = "Health Insurance" });
            modelBuilder.Entity<Benefit>().HasData(new Benefit { Id = 2, Description = "Paid Time Off" });
            modelBuilder.Entity<Benefit>().HasData(new Benefit { Id = 3, Description = "Wellness", Premium = true });
            modelBuilder.Entity<Benefit>().HasData(new Benefit { Id = 4, Description = "Education", Premium = true });
			modelBuilder.Entity<Benefit>().HasData(new Benefit { Id = 5, Description = "Store Discount" });
